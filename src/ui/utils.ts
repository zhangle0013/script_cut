...
/** 导出 JSON 时的固定下载文件名（与管线/Hermes 命名约定一致） */
export const SCRIPT_CUT_EXPORT_FILENAME = "03_ScriptCut已编辑.json";

/** @returns 固定导出文件名，见 {@link SCRIPT_CUT_EXPORT_FILENAME} */
export function editedExportFilename(): string {
  return SCRIPT_CUT_EXPORT_FILENAME;
}
